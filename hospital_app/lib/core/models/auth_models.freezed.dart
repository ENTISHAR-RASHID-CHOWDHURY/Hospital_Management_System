...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, role: $role, phone: $phone, specialization: $specialization, department: $department, licenseNumber: $licenseNumber, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
class _$TokenResponseImpl implements _TokenResponse {
  const _$TokenResponseImpl({required this.token, required this.refreshToken});
